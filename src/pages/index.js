    ...
    <div className="min-h-screen bg-purple-400 flex justify-center items-center">
        ...
        <div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
          ...
          <div className="space-y-4">
            <input type="text" placeholder="Username" value={name} onChange={(e)=> setname(e.target.value)} className="block text-sm py-3 px-4 rounded-lg w-full border outline-none" />
